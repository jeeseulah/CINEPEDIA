...
- 영화 제목 불러오기 흰 배경일 경우를 위해 그림자 사용
...
### 4) 영화 카드 MouseOver 효과

![영화카드마우스오버](https://github.com/jeeseulah/CINEPEDIA/assets/165135312/edb67ce2-1ee2-44cc-9562-e5fc64bee706)

- 영화 poster 이미지가 없을 경우 기본 이미지로 나타납니다.
- 별점 표시
